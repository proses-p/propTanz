...
const navigation = [
	...
	{ label: "My hostels", to: "/hostel-registration", icon: Building2 },
	{ label: "Apartments", to: "/apartments", icon: PanelsTopLeft },
			...
			<aside className={`fixed inset-y-0 left-0 z-50 flex w-[280px] flex-col border-r border-slate-200 bg-white px-5 py-7 shadow-2xl transition-transform duration-300 lg:sticky lg:top-0 lg:h-screen lg:translate-x-0 lg:shadow-none ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
				<div className="mb-12 flex items-center justify-between px-2">
					<div className="flex items-center gap-3">
						<div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#FDBF2D] text-xl font-black text-slate-950 shadow-[0_8px_18px_rgba(253,191,45,0.28)]">P</div>
						<div>
							<p className="text-lg font-black tracking-[-0.04em] text-slate-950">PangaEasy</p>
							<p className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#a87500]">Business space</p>
						</div>
					</div>
				...
				<div className="mt-auto rounded-2xl bg-[#fff8cf] p-4">
					<div className="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-[#FDBF2D] text-slate-950">
